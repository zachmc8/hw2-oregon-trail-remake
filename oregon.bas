...
260 PRINT "YOUR CARAVAN OF 5 WILL COVER THE 2040 MILE OREGON TRAIL"
...
6800 END
6810 REM ***WEEK 1 MAIN EVENT: FOOD GOES MISSING***
6820 PRINT "YOU NOTICE FOOD HAS GONE MISSING LATELY"
6830 PRINT "CHECK THE BELONGINGS OF A PASSENGER?"
6840 PRINT "CHECK (1) PASSENGER 1, (2) PASSENGER 2, (3) PASSENGER,"
6850 PRINT "OR (4) PASSENGER 4?"
6860 INPUT SUS
6870 IF SUS = 3 THEN 6890
6880 GOTO 6940
6890 PRINT "YOU FIND MORE FOOD THAN USUAL IN PASSENGER 3'S BELONGINGS."
6900 PRINT "WILL YOU (1) CONFRONT THEM OR (2) JUST TAKE THE FOOD BACK?"
6910 INPUT DEC
6920 IF DEC = 1 THEN 6980
6930 GOTO 7050
6940 PRINT "YOU FIND NOTHING OUT OF THE ORDINARY. MAYBE YOUR ARE"
6950 PRINT "IMAGINING THINGS. (YOU LOST FOOD!)"
6960 F=F-8-5*2 
6970 GOTO 2870
6980 PRINT "YOU ASK PASSENGER 3 WHY THEY HAVE EXTRA FOOD."
6990 PRINT "THEY HAVE NO GOOD EXPLANATION. WILL YOU (1) BRING THIS"
7000 PRINT "TO THE OTHER PASSENGERS OR (2) LET IT GO?"
7010 INPUT DEC
7020 IF DEC = 1 THEN 7070
7030 GOTO 7220
7050 PRINT "YOU PUT THE FOOD BACK IN STORAGE. PERHAPS YOU BETTER"
7060 PRINT "KEEP AN EYE ON PASSENGER 3."
7061 GOTO 2870
7070 PRINT "THE OTHER PASSENGERS GET ANGRY WITH PASSENGER 3. THEY WANT TO EITHER"
7080 PRINT "(1) ABANDON THEM IN THE WILDERNESS, (2) LEAVE THEM AT THE NEXT FORT,"
7090 PRINT "OR (3) GIVE THEM ANOTHER CHANCE."
7091 REP = REP + 1
7100 INPUT DEC
7110 IF DEC = 1 THEN 7140
7120 IF DEC = 2 THEN 7180
7130 GOTO 7220
7140 PRINT "YOU LEAVE THEM ALONE IN THE WILDERNESS WITH THEIR GUN"
7150 PRINT "AND A SINGLE BULLET. PERHAPS EVEN THAT IS TOO KIND FOR THEM."
7160 PAS = PAS - 1 
7170 GOTO 2870
7180 PRINT "YOU DECIDE TO DROP PASSENGER 3 OFF AT THE NEXT FORT. UNTIL THEN,"
7190 PRINT "IT'S BEST TO KEEP AN EYE ON THEM."
7200 BAD = BAD + .5 
7210 GOTO 2870
7220 PRINT "YOU DECIDE TO LEAVE PASSESENGER 3 ALONE. PERHAPS THEY ACTED"
7230 PRINT "ONLY OUT OF FOOLISH DESPERATION RATHER THAN MALICE."
7240 BAD = BAD + .2 
7250 GOTO 2870
7260 END